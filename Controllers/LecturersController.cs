...
namespace St10375622Part2.Controllers
{
    public class LecturersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LecturerId,Name,email,Location")] Lecturer lecturer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LecturerId,Name,email,Location")] Lecturer lecturer)
        {
